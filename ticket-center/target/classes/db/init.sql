...
-- Records of t_user
-- ----------------------------
INSERT INTO "public"."t_user" VALUES ('9999', '管理员', '4QrcOUm6Wau+VuBX8g+IPg==', 'admin', '0', now(), now(), '0', '1', '0', null, null, null, null, null, null, null, null, null, null) ON CONFLICT (id) DO NOTHING;
